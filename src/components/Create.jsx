...
const Create = () => {
  ...
  .object({
    ...
    comments: yup.string(),
    employees: yup.array().min(1, 'Pick at least one option from the list.'),
  ...
  const {control, handleSubmit} = useForm({defaultValues:defaultValues, resolver: yupResolver(schema)});
